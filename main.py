...
while True:
    ...
    choice = input_choice(8)
    if choice == 1:
        use_func(ui.request_add_client)
    elif choice == 2:
        use_func(ui.request_add_service)
    elif choice == 3:
        use_func(ui.request_add_appointment)
    elif choice == 4:
        use_func(ui.request_show_appointments)
    elif choice == 5:
        use_func(ui.request_find_appointment)
    elif choice == 6:
        use_func(ui.request_cancel_appointment)
    elif choice == 7:
